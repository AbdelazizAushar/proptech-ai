          ...
          <div className="relative z-10 px-12 max-w-2xl text-white space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl text-white/80 leading-relaxed font-light">
                إدارة الأصول العقارية والعمليات بنظرة شاملة ودقيقة. التجربة الرقمية الأكثر تطورا في السوق العقاري.
              </p>
            </div>
          ...
          <div className="flex-grow flex items-center justify-center p-8 lg:p-16">
            <div className="w-full max-w-md space-y-10">
              <div className="space-y-2 text-right">
                ...
                <p className="text-on-surface-variant font-medium">مرحبا بك مجددا في نظام الإدارة</p>
              </div>
